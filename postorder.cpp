...
// pls. refer https://onecompiler.com/c/3ys9s4ynu
...
int main(int argc, char *argv[]) {
    cout << "postorder tree traversal (c) sumith kumar puri" << endl;
    ...
    cout << endl << endl << "starting postorder traversal";
    postorder(root);
    // getch();    
}
